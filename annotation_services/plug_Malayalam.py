# ----------------------------------------------------------------------
# This script invokes Tesseract OCR API for malayalam language.
...
def get_annotations_data_tamil(im_path):
    """Obtaining annotations using Tesseract OCR(malayalam language).
    ...
    d = pytesseract.image_to_data(img, output_type=Output.DICT, config=tessdata_dir_config,lang="mal")
