# ----------------------------------------------------------------------
# This script invokes Tesseract OCR API for kannada language.
...
def get_annotations_data_kannada(im_path):
    """Obtaining annotations using Tesseract OCR(kannada language).
    ...
    d = pytesseract.image_to_data(img, output_type=Output.DICT, config=tessdata_dir_config,lang="kan")
