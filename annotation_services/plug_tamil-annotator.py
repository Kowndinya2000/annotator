# ----------------------------------------------------------------------
# This script is used to setup an annotation service for tamil language
# 
...
app = Flask(__name__)
app.config['UPLOAD_FOLDER'] = os.path.join(root_directory,'model-building','annotation-services-images-tamil')
...
@app.route('/plug/tesseract-tamil', methods=['GET', 'POST'])
def upload_file():
    ''' Uploads the image into annoation-services-images-tamil
