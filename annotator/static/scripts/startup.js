...
function LoadAnnotationSuccess(xml) {
  ...
  for(var pp = 0; pp < LMnumberOfObjects(LM_xml); pp++) {
    ...
    console.log(LMgetObjectField(LM_xml, pp, 'name'),LMgetObjectField(LM_xml, pp, 'id'))
    console.log('view Existing: ',view_Existing)
    console.log('isDeleted: ',isDeleted)
    console.log('X coordinates',LMgetObjectField(LM_xml, pp, 'x'))
